...
outputs = {
    "pred_rel_logits": torch.rand(2, 3, 2),
    "head_start_logits": torch.rand(2, 3, 5),
    "head_end_logits": torch.rand(2, 3, 5),
    "tail_start_logits": torch.rand(2, 3, 5),
    "tail_end_logits": torch.rand(2, 3, 5),
}
